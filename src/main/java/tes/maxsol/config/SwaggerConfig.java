...
public class SwaggerConfig {
    ...
    Contact contact = new Contact("Anjani", "http://localhost:8080/user-app-ws/v2/api-docs", "anjanie.nisa@gmail.com");
	...
	public Docket api()
	{
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.apis(RequestHandlerSelectors.basePackage("tes.maxsol.controller"))
