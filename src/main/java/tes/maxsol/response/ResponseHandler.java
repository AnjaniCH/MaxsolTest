...
public class ResponseHandler {
  ...
  public static ResponseEntity<Object> generateResponseTransaksi(Boolean status, HttpStatus code, String message, Object responseObj) {
    Map<String, Object> map = new HashMap<String, Object>();
    map.put("status", status);
    map.put("code", code.value());
    if(!status){
      map.put("message", "Id anggota tidak ada");
    } else {
      map.put("data", responseObj);
    }
